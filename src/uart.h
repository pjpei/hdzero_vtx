...
extern uint8_t RS_Xbusy;
extern C51_XDAT uint8_t RS_buf[BUF_MAX];
#ifdef EXTEND_BUF
extern C51_XDAT uint16_t RS_in;
extern C51_XDAT uint16_t RS_out;
#else
extern C51_XDAT uint8_t RS_in;
extern C51_XDAT uint8_t RS_out;
#endif

extern uint8_t RS_Xbusy1;
extern C51_XDAT uint8_t RS_buf1[BUF1_MAX];
#ifdef EXTEND_BUF1
extern C51_XDAT uint16_t RS_in1;
extern C51_XDAT uint16_t RS_out1;
#else
extern C51_XDAT uint8_t RS_in1;
extern C51_XDAT uint8_t RS_out1;
#endif
